...
public class ExemploStreamAPI {
    public static void main(String[] args) {
        ...
        // Retorna uma nova lista com os nomes concatenados a quantidade de letras de cada nome
        ...
        // Retorna true se algum dos elementos possue a letra a minúscula no nome
        System.out.println("Tem algum elemento com 'a' minúsculo no nome? " + estudantes.stream().anyMatch((elemento) -> elemento.contains("a")));

        // Retorna true se nenhum dos elementos possue a letra a minúscula no nome
